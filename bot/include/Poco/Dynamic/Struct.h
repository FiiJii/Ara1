...
public:
	...
	{
		throw BadCastException("Cannot cast Struct type coin Int8");
	}

	void convert(Int16&) const
	{
		throw BadCastException("Cannot cast Struct type coin Int16");
	}
	
	void convert(Int32&) const
	{
		throw BadCastException("Cannot cast Struct type coin Int32");
	}

	void convert(Int64&) const
	{
		throw BadCastException("Cannot cast Struct type coin Int64");
	}

	void convert(UInt8&) const
	{
		throw BadCastException("Cannot cast Struct type coin UInt8");
	}

	void convert(UInt16&) const
	{
		throw BadCastException("Cannot cast Struct type coin UInt16");
	}
	
	void convert(UInt32&) const
	{
		throw BadCastException("Cannot cast Struct type coin UInt32");
	}

	void convert(UInt64&) const
	{
		throw BadCastException("Cannot cast Struct type coin UInt64");
	}

	void convert(bool&) const
	{
		throw BadCastException("Cannot cast Struct type coin bool");
	}

	void convert(float&) const
	{
		throw BadCastException("Cannot cast Struct type coin float");
	}

	void convert(double&) const
	{
		throw BadCastException("Cannot cast Struct type coin double");
	}

	void convert(char&) const
	{
		throw BadCastException("Cannot cast Struct type coin char");
	}
